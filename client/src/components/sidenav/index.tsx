          ...
          <div className="flex flex-col gap-5">
            ...
            <li>
              <a
                ...
                className={`relative flex flex-row items-center ${
                  props.roles ? "text-red-500" : ""
                } focus:outline-none text-gray-700 gap-2 text-[0.8rem]   rounded-xl font-medium`}
              >
